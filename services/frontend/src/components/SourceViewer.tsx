              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {graphSources.map((src, idx) => (
                    <div
                      key={idx}
                      className="bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800 p-2 rounded-md text-xs"
                    >
                ...
                <div className="grid gap-2">
                  {vectorSources.map((src, idx) => {
                    ...
                    return (
                      <Card
                        key={idx}
                        className="p-3 text-sm bg-muted/50 border-none shadow-sm"
                      >

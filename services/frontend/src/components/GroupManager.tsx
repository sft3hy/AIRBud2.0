...
import { Globe, Copy, Trash2, LogIn, LogOut, Lock, Check, Users, Search, XCircle, Pencil, X } from 'lucide-react';
                        ...
                        <TabsContent value="my_groups" className="mt-0 space-y-4">
                            ...
                            {filteredMyGroups.length === 0 && (
                                <div className="text-center py-12 border-2 border-dashed rounded-xl text-muted-foreground bg-muted/20">
                                    {myGroupsSearchQuery ? "No groups match your search." : "No groups yet. Create one in the sidebar!"}
                                </div>
                            )}
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                ...
                                {filteredPublicGroups.length === 0 && (
                                    <div className="col-span-2 flex flex-col items-center justify-center py-12 text-muted-foreground">
                                        ...
                                        <p>{publicSearchQuery ? "No groups match your search." : "No public groups found."}</p>
                                    </div>
                                )}
                            </div>
                        </TabsContent>

  ...
  return (
    <div className="h-full w-full overflow-hidden font-sans selection:bg-primary/20">
      <ScrollArea className="h-full w-full bg-transparent" scrollbarClassName="mt-17">
        ...
        <div className="mx-auto space-y-8 max-w-4xl scroll-smooth">
            ...
            <div className="mx-auto space-y-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  Maximize your document intelligence and collaboration
                  workflows.
                </p>
              </div>
                      ...
                      <AccordionContent className="px-2 text-muted-foreground leading-relaxed pt-2 pb-4">
                        <div className="flex items-start gap-4 p-4 bg-background/50 rounded-lg border">
                          ...
                          <div className="space-y-3">
                            ...
                            <p>
                              You can only delete what you created. If you are
                              the creator of a group/collection, you can delete
                              it. For documents, only collection owners can
                              delete documents.
                            </p>
                            <ul className="list-disc pl-5 space-y-1 text-sm marker:text-primary">
                              <li>
                                If you created the Collection/Group, you will
                      ...
                      <AccordionContent className="px-2 text-muted-foreground leading-relaxed space-y-4 pt-2 pb-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="p-4 rounded-lg border bg-background/50">
                            ...
                            <p className="text-sm">
                              Hidden from the Explore tab. Access is restricted
                              to invitation only via an{" "}
                              <strong>Invite Link</strong> sent by a member.
                            </p>
                          </div>
                        </div>
                      </AccordionContent>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm mt-1">
                              ...
                              <strong>
                                your chat history is unique to you.
                              </strong>{" "}
                              Other members can see the documents, but they
                              cannot see your conversations.
                            </p>
                          </div>
                        </div>
                      </AccordionContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/60 dark:bg-black/40 p-5 rounded-lg border border-red-500/20">
                      ...
                      <ul className="text-sm space-y-2 text-muted-foreground">
                        ...
                        <li>
                          • Documents containing only images with no text.
                        </li>
                        <li>

                  ...
                  <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-lg border">
                    ...
                    <div>
                      ...
                      <p className="mb-2">
                        ...
                        That means if you are not the collection owner and want
                        a document deleted, you must reach out to the colleciton
                        owner for deletion.
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-sm">
                        ...
                        <li>
                          ...
                          <strong>cannot</strong> delete it. You can only view
                          and chat.
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1">
                        ...
                        Other members can see the documents, but they cannot see
                        your conversations.
                      </p>
                    </div>
                  </div>

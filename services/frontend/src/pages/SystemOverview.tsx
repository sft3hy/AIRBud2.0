      ...
      <div className="flex-1 overflow-y-auto relative scroll-smooth">
        ...
        <div className="relative z-10 min-h-full p-6 md:p-12 animate-in fade-in duration-700 slide-in-from-bottom-4">
          <div className="mx-auto space-y-12">
            {/* Sticky Header */}
            <div className="sticky top-0 z-40 -mx-6 md:-mx-12 px-6 md:px-12 py-4 bg-background/80 backdrop-blur-xl border-b border-border/40 flex items-center justify-between mb-8 transition-all">
              <Link to="/">
                <Button
                  variant="ghost"

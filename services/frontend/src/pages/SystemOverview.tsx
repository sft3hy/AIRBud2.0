            ...
            <section className="grid md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-2 space-y-4">
                ...
                <p className="leading-relaxed text-lg text-muted-foreground">
                  <strong>Retrieval-Augmented Generation (RAG)</strong> bridges
                  the gap between a static Large Language Model (LLM) and your
                  private data. Instead of relying on the model's training data,
                  we mathematically retrieve relevant snippets from your vector
                  index and feed them to the model as context at runtime.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="group hover:border-primary/50 transition-all duration-300 shadow-sm hover:shadow-md">
                  ...
                  <CardContent className="text-muted-foreground leading-relaxed space-y-3">
                    <p>
                      Vector search handles similarity, but fails at structure.
                      We utilize{" "}
                    ...
                    <p className="text-sm">
                      ...
                      "multi-hop" reasoning—connecting disparately worded facts
                      that refer to the same entity across documents.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="group hover:border-primary/50 transition-all duration-300 shadow-sm hover:shadow-md">
                  ...
                  <CardContent className="text-muted-foreground leading-relaxed space-y-3">
                    ...
                    <p className="text-sm">
                      ...
                      (e.g., <strong>Moondream2</strong>), converting visual
                      data into semantic text descriptions for the search
                      engine.
                    </p>
                  </CardContent>
                </Card>
